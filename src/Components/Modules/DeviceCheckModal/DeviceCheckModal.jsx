...
const navigate=useNavigate()
  ...
  async function handleContinue(){
    ...
    try {
      let url = BASE_URL + "/StartAssessment"
      ...
      case 1:
        return (
          ...
          <div className="flex items-center p-4 border rounded-lg shadow-md">
               ...
               {!micworking ? <button onClick={()=>startMicrophone()}>Verified</button> :  <div className="flex items-center text-green-600">Verified <MdOutlineDone className="bg-black text-white rounded-full h-5 w-5 ml-2"/></div>}
              </div>
          <div className="flex items-center p-4 border rounded-lg shadow-md">
                <div className="flex-shrink-0 mr-4">
                  <svg
                ...
                {!cameraworking ? <button onClick={startCamera}>Verified</button> : <div className="flex items-center text-green-600">Verified <MdOutlineDone className="bg-black text-white rounded-full h-5 w-5 ml-2"/></div>}
